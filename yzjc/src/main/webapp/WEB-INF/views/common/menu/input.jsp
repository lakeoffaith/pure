...
<html lang="en">
  ...
  <body>
     <div class="modal-dialog mid-modal"  menu="document">
      <div class="modal-content">
        ...
        <form action="menu" class="form-horizontal" id="domainFormID" method="post">
        <!-- //表单令牌 -->
      				<!-- <s:token></s:token> -->
           ...
           <div class="form-group hidden"  >
                            	...
                            	<div class="col-sm-4">
                            		<input  class="form-control"  name="id"  readonly="true"  value="${menu.id}">
                            	</div>
                          </div>
            </c:if>
             <div class="form-group">
							    <label  class="col-sm-2  col-md-offset-1 control-label">菜单名称</label>
							    <div class="col-sm-4">
