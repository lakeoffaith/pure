...
<body>
	...
	loadHospital();
										...
										.each(
												...
												function(e, v) {
													...
													e_str += "<div class='thumbnail' style='border: none; position: relative; padding-left: 170px; border-bottom: 1px solid #ededed;'>"
															...
															+ "<h3 class='text-info'  onclick='show('hospital/show',"
															+ v.id
															+ ")''>"+v.name+"<small class='text-showy'> [二甲医院]</small></h3>"
															+ "<p>地址："
															+ v.address
															+ "</p><p>电话："
															+ v.tel
										...
										.each(
												...
												function(e, v) {
													...
													e_str += "	<div class='thumbnail'  style='border: none; position: relative; padding-left: 60px; border-bottom: 1px solid #ededed; padding-top: 0px;'>"
															...
															+ v.id
															+ "\")'>"
															+ "<div class='caption'><p class='text-info' onclick='show('hospital/show',"
															+ v.id
															+ ")'>"
															+ v.name
										...
										.each(
												...
												function(e, v) {
													...
													e_str += "<div class='thumbnail'  style='border: none; position: relative; padding-left: 60px; border-bottom: 1px solid #ededed;'>"
															...
															+ v.id
															+ "\")'>"
															+ "<div class='caption'  style='padding-right: 20px;''><p class='text-info' onclick='show('hospital/show',"
															+ v.id
															+ ")'>"
															+ v.name
															+ "</p>"
		...
		$(function() {
			//加载医院查询class
 			initHosChooseClass({'name':'level','value':'级别'}); 
			initHosChooseClass({'name':'type','value':'类型'});
