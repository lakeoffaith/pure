...
<!--      <script src="js/jquery.scrollTo.min.js"></script>
  ...
  <body>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12" style="margin: 0px 15px 0px">
                      <section class="panel">
                            ...
                            <tr>
                              <th colspan="10" class="oprow-btn">
                              	...
                              	<div class="col-lg-8 col-md-8 col-sm-8">
    								...
    								<input type="button" id="newInputDomainID" class="hidden"   onclick="doModelDomain('menu','goSave')"></input>
    								<label for="batchDeleteDomainID" class="btn btn-danger " ><i class="icon-trash">&nbsp;批量删除</i></label>
    								<input type="button" id="batchDeleteDomainID" class="hidden"  style="margin-left:10px"  onclick="doModelDomain('menu','batchDelete')"></input>
    								</div>
    								<div class="col-lg-4 col-md-4 col-sm-4" align="right">
								  	
								  	<form action="menu" method="get"  id="domainForm"   style="display: inline-block;" >
								  	<label >登录账号</label>
								  		<input name="name"  id="name"  Class="form-control" Style="width:100px;display: inline-block;"  value="${menuQuery.name}">
    								...
    								<input type="button" id="searchDomainID" class="hidden" style="float: right"  onclick="doModelDomain('menu','search')"></input>
								  	</form>
                          ...
                          <tbody >
                              ...
                              <td>
                                  	<label for="viewDomainID" class="btn btn-success btn-xs" title="查看" onclick="doModelDomain('menu','get','${r.id}')"><i class="icon-file"></i></label>
    								<input type="button" id="viewDomainID" class="hidden"   ></input>
                                   <label for="inputDomainID" class="btn btn-primary btn-xs" title="编辑" onclick="doModelDomain('menu','goUpdate','${r.id}')"><i class="icon-pencil"></i></label>
    								<input type="button" id="inputDomainID" class="hidden"   ></input>
                                   <label for="deleteDomainID" class="btn btn-danger btn-xs" title="删除" onclick="doModelDomain('menu','delete','${r.id}')"><i class="icon-trash"></i></label>
              ...
              <!-- page end-->
              <page:htmlPage pageNo="${pageResult.currentPage}" url='menu'  totalSum="${pageResult.totalCount}"  showPage="5" pageSize="${pageResult.pageSize}"/>
    <!-- js placed at the end of the document so the pages load faster -->

   			  <div class="modal fade bs-example-modal-lg" id="myModal" tabindex="-1" menu="dialog" aria-labelledby="myModalLabel"></div>
