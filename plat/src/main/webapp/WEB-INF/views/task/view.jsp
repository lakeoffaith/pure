...
<html lang="en">
  ...
  <body>
  	<div class="modal-dialog modal-lg"  style="width:40%" task="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
      					  ...
      					  <%-- <c:when test="task.id!=null">
                            	...
                            	<div>序号</div>
                            	<div>
                            		<input  class="form-control" name="id"  readonly="true"  value="${task.realName}">
                            	</div>
                          </div>
      					  </c:when> --%>
                            	...
                            	<div class="col-sm-4">
                            		<input  class="form-control"  name="id"  readonly="true"  value="${task.id}">
                            	</div>
                          </div>
      					    <div class="form-group">
							    <label  class="col-sm-2  col-md-offset-1 control-label">任务名称</label>
							    <div class="col-sm-4">
