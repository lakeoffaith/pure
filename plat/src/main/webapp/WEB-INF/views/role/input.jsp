  ...
  <body>
     <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="<%=basePath%>role/save.action" class="form-horizontal" id="domainFormID" method="post">
        <!-- //表单令牌 -->
      				<s:token></s:token>
      		<s:if test="id!=null">
            ...
            <div class="form-group">
              <div>角色名称</div>
              <div><s:textfield cssClass="form-control" name="name" />
              </div>
            </div>
            <div class="form-group">
              <div>角色描述</div>
              <div><s:textfield cssClass="form-control" name="describe" />
              </div>
            </div>
            <div class="form-group">
