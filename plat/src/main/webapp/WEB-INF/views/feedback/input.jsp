...
<html lang="en">
  ...
  <body>
      ...
      <div class="modal-content">
        ...
        <form action="<%=basePath%>feedback/save.action" class="form-horizontal" id="domainFormID" method="post">
      					<!-- //表单令牌 -->
      				<s:token></s:token>
                          <s:if test="id!=null">
            <div class="form-group">
              ...
              <div><s:textfield cssClass="form-control" name="id" readonly="true"/>
                           ...
                           <div class="form-group">
                            	<div>反馈电话</div>
                            	<div><s:textfield cssClass="form-control" name="cellphone"/></div>
                          </div>
                          <div class="form-group">
                            	<div>反馈地址</div>
                            	<div><s:textfield cssClass="form-control" name="locationPath"/></div>
                          </div>
                         <div class="form-group">
