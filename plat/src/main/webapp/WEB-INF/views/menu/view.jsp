...
<html lang="en">
  ...
  <body>
  	<div class="modal-dialog modal-lg"  style="width:40%" menu="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="myModalLabel">菜单查看</h4>
        </div>
        <div class="modal-body">
      					  ...
      					  <%-- <c:when test="menu.id!=null">
                            	...
                            	<div>序号</div>
                            	<div>
                            		<input  class="form-control" name="id"  readonly="true"  value="${menu.realName}">
                            	</div>
                          </div>
      					  </c:when> --%>
