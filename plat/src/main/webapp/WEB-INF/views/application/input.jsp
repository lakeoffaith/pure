...
<html lang="en">
  ...
  <body>
      ...
      <form action="<%=basePath%>application/save.action" class="form-horizontal" id="domainFormID" method="post">
      					<!-- //表单令牌 -->
      					<s:token></s:token>
                          ...
                          <div class="form-group">
                            	<div>应用描述</div>
                            	<div><s:textfield cssClass="form-control" name="brief"/></div>
                          </div>
                          <div class="form-group">
                            	<div>应用开始时间</div>
                          ...
                          <div class="form-group">
                            	<div>维护合同</div>
                            	<div><s:textfield cssClass="form-control" name="docpath"/></div>
                          </div>
                           <div class="form-group">
