...
<html lang="en">
  ...
  <body>
  	<div class="modal-dialog modal-lg"  style="width:40%" application="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="myModalLabel">应用查看</h4>
        </div>
        <div class="modal-body">
      					  ...
      					  <%-- <c:when test="application.id!=null">
                            	...
                            	<div>序号</div>
                            	<div>
                            		<input  class="form-control" name="id"  readonly="true"  value="${application.realName}">
                            	</div>
                          </div>
      					  </c:when> --%>
      					    ...
      					    <div class="form-group">
							    <label  class="col-sm-2  col-md-offset-1 control-label">名称</label>
							    <div class="col-sm-4">
