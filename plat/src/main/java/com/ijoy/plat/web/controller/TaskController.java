...
public class TaskController {
	...
	public  ModelAndView  list(@ModelAttribute TaskQuery baseQuery){
	...
	public Ajaxresult update(@ModelAttribute Task task){
		return null;
	}
	//进入新增单个
	...
	public Ajaxresult save(@ModelAttribute Task task){
		return null;
	}
	//删除单个
